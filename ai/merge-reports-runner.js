/**
 * ai/merge-reports-runner.js
 *
 * Self-healing runner for tests/merge-reports.spec.ts
 *
 * Flow:
...
async function main() {
  console.log('═══════════════════════════════════════════════════════');
  console.log(' Self-Healing Runner — tests/merge-reports.spec.ts');
  console.log('═══════════════════════════════════════════════════════');
  ...
  while (attempt <= MAX_RETRIES) {
    ...
    if (anyFixed) {
      if (attempt === 1) {
        ...
        console.log(`\n💾 Original backed up to tests/merge-reports.spec.ts.bak`);
      }
